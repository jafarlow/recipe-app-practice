...
const Home = () => {
  return (
    <div className="Home">
      <h1>Home</h1>
      <h2>About the app:</h2>
      <p>This is a recipe search app which uses the Edamam API to help you find new dishes to cook. This is a great way to quickly scan a recipe's ingredients to help you determine if you've found your next favorite dish! Each recipe includes a link to its source page where you can find the cooking instructions. Just imagine, finding the ingredients for a recipe <em><strong>before</strong></em> having to scroll past those stories!</p>
